...
//按照vtec计算的方式读取o文件
bool readofile_vtec(string stro, pobs obsfile);
//读取ionex文件
...
void read_a0(string path, double** ctable);//读取2阶之后的周期系数表
void read_coe(string path, double coe[][25]);//读取所有阶数球谐函数周期系数表
